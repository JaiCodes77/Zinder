        ...
        <div className="p-4 border-t border-white/5 space-y-4">
          <div className="flex items-center gap-3 px-2">
            <div className="w-9 h-9 rounded-full bg-gradient-to-tr from-brand-teal to-brand-purple p-[1.5px]">
              <div className="w-full h-full rounded-full bg-[#0a0f1e] overflow-hidden flex items-center justify-center font-bold text-xs text-brand-teal">
                AX
              </div>
            </div>
            {!sidebarCollapsed && (
      ...
      <main className="flex-1 flex flex-col min-h-screen pb-16 md:pb-0 z-10 overflow-y-auto">
        ...
        {activeTab === 'profile' && (
          <div className="flex-1 flex items-center justify-center p-6 md:p-12">
            <div className="w-full max-w-lg glass-card rounded-3xl p-8 border border-white/5">
              ...
              <div className="flex flex-col items-center border-b border-white/5 pb-8">
                ...
                <h2 className="mt-4 text-xl font-bold text-white tracking-tight">Alex Mercer</h2>
                <p className="text-xs text-zinc-500 mt-1 uppercase tracking-widest font-semibold">Gateway Administrator</p>
              </div>
              ...
              <div className="mt-8 space-y-6">
                <div>
                  ...
                  <div className="mt-2.5 grid grid-cols-2 gap-3 text-sm">
                    <div className="p-3 bg-zinc-950/40 rounded-xl border border-white/5">
                      ...
                      <span className="font-semibold text-white mt-0.5 block">Developers & Designers</span>
                    </div>
                    <div className="p-3 bg-zinc-950/40 rounded-xl border border-white/5">
                      <span className="text-[10px] text-zinc-500 block">Radius limit</span>
                      <span className="font-semibold text-white mt-0.5 block">25 miles</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-4 flex gap-4">
                  <button
                    ...
                    className="flex-1 py-3 px-4 rounded-xl border border-white/10 hover:border-white/20 bg-zinc-950/40 hover:bg-zinc-900/60 text-sm font-semibold transition-all text-center"
                  >
                    Edit Profile
                  </button>
                  ...
                  <button
                    type="button"
                    onClick={onLogout}
                    className="flex-1 py-3 px-4 rounded-xl bg-red-500/10 hover:bg-red-500/20 border border-red-500/20 text-red-400 text-sm font-semibold transition-all text-center"
                  >
                    Disconnect
                  </button>
                </div>
